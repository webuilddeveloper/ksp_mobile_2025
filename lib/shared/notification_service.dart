...
import 'package:ksp/page/knowledge/knowledge_form.dart';
import 'package:ksp/page/news/news_form.dart';
import 'package:ksp/page/notification/notification_expireform.dart';
...
_updateBagder(message) async {
  ...
  if ((_username != null && _username != '') &&
    ...
    var _futureNoti = postDio('${notificationApi}count', {
      "username": _username,
      "category": _category,
    });
...
class NotificationService {
  ...
  Future<void> _refreshToken() async {
    ...
    FirebaseMessaging.instance.getToken().then((token) async {
      ...
      String? value = await storage.read(key: 'dataUserLoginKSP');
      if (value != null && value != '') {
        print(value);
        ...
        http.post(
          Uri.parse(
            'https://ksp.we-builds.com/ksp-api/m/register/token/create',
          ),
          body: body,
          headers: {
  ...
  void _tokenRefresh(String newToken) async {
    ...
    if (value != null && value != '') {
      ...
      http.post(
        Uri.parse('http://ksp.we-builds.com/ksp-api/m/register/token/create'),
        body: body,
        headers: {
          "Accept": "application/json",
          "Content-Type": "application/json",
    ...
    FirebaseMessaging.onMessageOpenedApp.listen((RemoteMessage message) async {
      ...
      if (notification != null && android != null) {
        ...
        switch (message.data['page']) {
          ...
          case 'VETEXAM':
            {
              var _notificationPage = await postDio('${notificationApi}read', {
                'skip': 0,
                'limit': 1,
                'reference': message.data['code'],
              });
              ;
