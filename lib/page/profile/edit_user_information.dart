...
class _EditUserInformationPageState extends State<EditUserInformationPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: header(context, goBack, title: 'บัญชีผู้ใช้งาน'),
      ...
      child: Padding(
        ...
        child: ListView(
          ...
          children: [
            ...
            labelTextFormFieldProfile('คำนำหน้า'),
            ...
            labelTextFormFieldProfile('ชื่อ'),
            textFormFieldProfile(
              txtFirstName,
              null,
              'ชื่อ',
            ...
            labelTextFormFieldProfile('นามสกุล'),
            textFormFieldProfile(
              txtLastName,
              null,
              'นามสกุล',
            ...
            labelTextFormFieldProfile('อีเมล'),
