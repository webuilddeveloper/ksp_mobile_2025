...
import 'package:ksp/page/notification/main_page_form.dart';
...
import 'package:ksp/page/warning/warning_form.dart';
import 'package:ksp/page/welfare/welfare_form.dart';
        ...
        decoration: BoxDecoration(
          color:
              model['status'] == 'A'
                  ...
                  : Color(0xFFFF9300).withOpacity(0.2),
          borderRadius: BorderRadius.circular(10),
        ),
        child: Row(
          ...
          title: Column(
            ...
            children: <Widget>[
              Align(
                alignment: Alignment.topRight,
                child: IconButton(
                  icon: Icon(Icons.close, color: Color(0xFFFF9300), size: 35),
                  onPressed: () {
                    Navigator.pop(context);
                  },
                ),
