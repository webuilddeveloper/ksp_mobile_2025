...
import 'package:ksp/page/conference/conference_form.dart';
import 'package:ksp/shared/api_provider.dart';
import 'package:ksp/widget/blank.dart';
import 'package:ksp/widget/loading.dart';

class ConferenceListVertical extends StatefulWidget {
  ConferenceListVertical({
    Key? key,
    required this.model,
    required this.url,
    this.urlComment = '',
  ...
  @override
  _ConferenceListVertical createState() => _ConferenceListVertical();
}

class _ConferenceListVertical extends State<ConferenceListVertical> {
  @override
  void initState() {
    super.initState();
  }
