...
class ContactListVerticalOld extends StatefulWidget {
  ContactListVerticalOld({
    Key? key,
    required this.model,
    required this.title,
    required this.url,
  ...
  @override
  _ContactListVerticalOld createState() => _ContactListVerticalOld();
}

class _ContactListVerticalOld extends State<ContactListVerticalOld> {
  @override
  void initState() {
    super.initState();
  }
