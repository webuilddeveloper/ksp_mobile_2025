...
import 'package:ksp/page/poll/poll_dialog.dart';
...
class _PollDetailPageState extends State<PollForm> {
  ...
  late List<List<TextEditingController>> ooo = [];
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        List.generate(
          ...
          (i) => ooo[index].add(TextEditingController()),
        );
        return Column(
          children: [
            Container(
  ...
  pollReply(dynamic model) async {
    ...
    if (checkSendReply) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => PollDialog()),
      );
      // showDialog(
      //   barrierDismissible: false,
      //   context: context,
