...
class EthicsForm extends StatefulWidget {
  EthicsForm({Key? key, required this.code, this.model}) : super(key: key);
  final String code;
  final dynamic model;

  @override
  _EthicsDetailPageState createState() => _EthicsDetailPageState(code: code);
}

class _EthicsDetailPageState extends State<EthicsForm> {
  _EthicsDetailPageState({required this.code});
  ...
  void initState() {
    super.initState();
    _futureModel = post('${ethicsApi}read', {
      'skip': 0,
      'limit': 1,
      'code': widget.code,
    });
