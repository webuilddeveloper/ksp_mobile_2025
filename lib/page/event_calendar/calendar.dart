...
import 'package:ksp/page/event_calendar/event_utils.dart';
...
class _CalendarPageState extends State<CalendarPage>
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    _checkDateString(event['dateStart'], event['dateEnd']),
  ...
  _checkDateString(dateStart, dateEnd) {
    ...
    if (dateEnd == '') return dateStringToDate(dateStart);
    return dateStringToDate(dateStart) + ' - ' + dateStringToDate(dateEnd);
  }
}
